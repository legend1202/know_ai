...
import FootballFixtures from "./pages/AiTipster.tsx/FootballFIxtures.";
import Tbd from "./pages/AiTipster.tsx/Tbd";
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      {
        path: "",
        element: <Navigate replace={true} to="knowleechats" />,
      },
      {
        path: "connectors",
      ...
      {
        path: "test-tolt-io-subscriptions",
      ...
      },
      {
       ...
       children:[
        {
          path:"",
          element:<Navigate replace={true} to="football-fixtures" />,
        },
        {
          path:"football-fixtures",
          element:<FootballFixtures/>
        },
        {
          path:"football-tbd",
          element:<Tbd/>
