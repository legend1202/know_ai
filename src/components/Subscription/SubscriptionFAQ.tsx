...
const faqList = [
  ...
  */
    ...
    },
    {
        ...
        answer: "Knowlee uses sophisticated AI algorithms to provide the best possible answer. If it can't answer your question, it means the information is currently not in its knowledge base. However, Knowlee learns continuously and updates its knowledge base regularly.",
    },
];
